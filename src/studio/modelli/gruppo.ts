...
export const gruppo: Modello = {
  ...
  elementi: [
    ...
    { id: "icona", tipo: "immagine", fonte: "/studio/whatsapp.png", riquadro: { x: 43.4, y: 17.8, larghezza: 13.2, altezza: 7.4 }, riempimento: "contain" },
    { id: "riq", tipo: "forma", riquadro: { x: 16.5, y: 28.5, larghezza: 67, altezza: 10 }, colore: RIQUADRO, raggio: 2.7 },
    {
      id: "occhiello", tipo: "testo", campo: "occhiello",
      riquadro: { x: 19, y: 30.0, larghezza: 62, altezza: 3.4 },
    ...
    },
    {
      ...
      riquadro: { x: 19, y: 33.6, larghezza: 62, altezza: 3.6 },
