...
// rigenerare le icone lo installa al momento (`npm i -D playwright`).
...
for (const [size, src, out] of [
  [192, svgApp, "public/icon-192.png"],
  [512, svgApp, "public/icon-512.png"],
  ...
  [180, svgApp, "public/apple-touch-icon.png"],
]) {
